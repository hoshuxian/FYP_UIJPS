...
<div class="choose">
    ...
    <button onclick="location.href='{{ url('/displaystdfeedback') }}'"type="submit" class="student" value="student"> STUDENT</button>
...
<div class=search2>
    <form action="/displayempfeedback/search" method="GET" role="search">
        <div class="input-group">
            ...
            <a href="/displayempfeedback">&emsp;<button  class="refreshbtn" type="button" title="Refresh page"><ion-icon name="repeat-outline"></ion-icon></button></a>
        </div>
                    @if(!empty($successMsg))
