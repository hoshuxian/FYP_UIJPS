...
<div class=search2>
    <form action="/report/search" method="GET" role="search">
        <div class="input-group">
            ...
            <a href="/report">&emsp;<button  class="refreshbtn" type="button" title="Refresh page"><ion-icon name="repeat-outline"></ion-icon></button></a>
        </div>
                    @if(!empty($successMsg))
