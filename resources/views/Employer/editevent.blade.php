...
<form action='/eventedit' method='post'enctype="multipart/form-data">
...
@endif
    ...
    <a href='/showevent/{{$detaa->id}}' type="button "value="Back" class="button" style="padding: 0.5rem 1.5rem;">BACK</a>
    @endforeach
  </form>
</div>
