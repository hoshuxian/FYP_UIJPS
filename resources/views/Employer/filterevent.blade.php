...
<div class=search2>
    <form action="/filterevent/search" method="GET" role="search">
        <div class="input-group">
            ...
            <a href="/filterevent">&emsp;<button  class="refreshbtn" type="button" title="Refresh page"><ion-icon name="repeat-outline"></ion-icon></button></a>
        </div>
                    @if(!empty($successMsg))
