  ...
  <section>
        <div class="user login">
          ...
          <div class="form-box">
            ...
            <form action='staffsignup' id="staffsignupform"method='post'enctype="multipart/form-data">
@csrf
              <div class="form-control">
              <h2>Welcome!</h2>
                <p>It's good to have you.</p>
                <div class="input-icons"> 
                <input id="staffname" placeholder="Staff's Name" type="text" name="staffname" required></input>
                <input id="staffemail" placeholder="Staff's Email Address" type="text" name="staffemail" required></input>
                  <input id="staffphonenum" type="text" placeholder="Staff's Phone Number" name="staffphonenum" required></input>
                  <input id="staffpassword" placeholder="Password" type="password" name="staffpassword" required></input>
                  <div class="icon hide">
                     <img src="/eye.svg" alt=""/>
                  </div>
                  <div>
                  <input id="staffconfirmpass" type="password" placeholder="ConfirmPassword" name="staffconfirmpass" required></input>
                  <select id="stafffaculty" name="stafffaculty" required>
