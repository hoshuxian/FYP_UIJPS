...
section form .form-control button[type="button"] {
  display: block;
  text-align: center;
  width: 100%;
  border: none;
...
section form .form-control button[type="button"]:hover {
  background-color: var(--lightblue);
}
    </style>
          ...
          <div class="form-box">
            <form action='rating' id="studentsignupform"method='post'enctype="multipart/form-data">
              ...
              <h2>Welcome!</h2>
                ...
                <button  onclick="location.href='{{ url('/showstdprofile') }}'" type="button">BACK</button>
              </div>
            </form>
          </div>
        </div>
