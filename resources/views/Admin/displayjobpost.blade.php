...
<p style="color:red;font-size: 24px;float:right;;margin-top:-5%;">{{$detaa->job_applynumber}}<span style="font-size:15px;color:black;margin-left:10px;">applicants</span></p></a>
<p style="color:red;font-size: 24px;margin-right:10px;float:right;margin-top:-1%;">{{$detaa->hired}}<span style="font-size:15px;color:black;margin-left:10px;">hired / {{$detaa->position_available}}</span></p></a>
