...
<div class=search2>
    <form action="/viewjobpost/search" method="GET" role="search">
        <div class="input-group">
            ...
            <a href="/viewjobpost">&emsp;<button  class="refreshbtn" type="button" title="Refresh page"><ion-icon name="repeat-outline"></ion-icon></button></a>
        </div>
                    @if(!empty($successMsg))
...
<a href="/displayjobpost/{{ $detaa->post_id}}"><div class="container3">
